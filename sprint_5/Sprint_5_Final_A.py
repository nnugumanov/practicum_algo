...
-- ДОКАЗАТЕЛЬСТВО КОРРЕКТНОСТИ --
    Куча - это бинарное дерево, хранимое в массиве,
    обладающее свойствами:
     - у i-го узла левый и правый потомок находятся по индексу 2i, 2i+1
     - узлы дерева упорядочены по приоритету (в нашем случае по возрастанию, узел имеет меньший приоритет чем его потомки).
    Последовательное добавление и извлечение узлов из вершины кучи, с "просеиванием вверх/вниз", сохраняет упорядоченность.
    Это гарантирует то что извлекаемые из кучи элементы дадут отсортированный список.

    (честно говоря, этот пункт про доказательство корректности вызывает у меня большие вопросы, ведь честное формальное
    доказательство корректности алгоритма - это целая отдельная задача. А в том виде в котором я пишу, это очень похоже
    на дубликат ПРИНЦИПА РАБОТЫ).
